...
const PITODO_PI_USER_ID_STORAGE_KEY = "pitodo_pi_user_id"
const PITODO_PI_UID_STORAGE_KEY = "pitodo_pi_uid" // used by Account/Admin pages
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const logout = () => {
    ...
    localStorage.removeItem(PITODO_PI_USERNAME_STORAGE_KEY)
      localStorage.removeItem(PITODO_PI_UID_STORAGE_KEY)
